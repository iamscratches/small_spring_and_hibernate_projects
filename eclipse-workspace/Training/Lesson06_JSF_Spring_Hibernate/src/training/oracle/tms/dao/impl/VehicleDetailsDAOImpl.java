...
public class VehicleDetailsDAOImpl implements VehicleDetailsDAO {
	...
	public void updateDetails(VehicleDetailsEO vehicleDetailsEORef) {
		Session sessionRef = HibernateUtil.getSessionFactory().openSession();
		sessionRef.beginTransaction();
		VehicleDetailsEO vehicleDetailsEOToBeUpdated = (VehicleDetailsEO)sessionRef.get(VehicleDetailsEO.class, vehicleDetailsEORef.getVehicleID());
		vehicleDetailsEOToBeUpdated.setVehicleName(vehicleDetailsEORef.getVehicleName());
		vehicleDetailsEOToBeUpdated.setVehicleType(vehicleDetailsEORef.getVehicleType());
		vehicleDetailsEOToBeUpdated.setVehicleColor(vehicleDetailsEORef.getVehicleColor());
		vehicleDetailsEOToBeUpdated.setCubicCapacity(vehicleDetailsEORef.getCubicCapacity());
		vehicleDetailsEOToBeUpdated.setdOM(vehicleDetailsEORef.getdOM());
